...
return [
    ...
    'footer' => [
        'github' => [
            'open' => true,
            'url'  => 'https://github.com/BAC',
        ],
        'twitter' => [
            'open' => true,
            'url'  => 'https://twitter.com/BAC'
        ],
        'meta' => '© Blog 2021. Powered By BAC',
    ],

    'license' => 'Powered By BAC.<br/>This article is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-nc/4.0/">Creative Commons Attribution-NonCommercial 4.0 International License</a>.',
